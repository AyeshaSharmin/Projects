...
public class UserRegistrationTwoAndOrderConfirm extends DriverSetup {
	...
	public static void registrationAndBuy() throws InterruptedException {
		...
		driver.findElement(By.xpath("//input[contains(@id,'email_create')]")).sendKeys("demogmail24@gmail.com");
		...
		driver.findElement(By.xpath("//input[contains(@id,'customer_firstname')]")).sendKeys("Nevine");
		driver.findElement(By.xpath("//input[contains(@id,'customer_lastname')]")).sendKeys("Acotanza");
		...
		driver.findElement(By.xpath("//input[@name='firstname']")).sendKeys("Nevine");
		driver.findElement(By.xpath("//input[@name='lastname']")).sendKeys("Acotanza");
